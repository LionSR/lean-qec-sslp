...
\item \textbf{Z-type Knill--Laflamme (Eq.~6)}: linear $\langle Z_i \rangle$ constraints formalized via \texttt{zSign}, \texttt{zExpectation}, \texttt{ZTypeKL}/\texttt{ZTypeKL'}, and \texttt{SSLPSetup}.
\end{itemize}
