...
theorem code_14000_ok : code_14000.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
...
theorem code_14001_ok : code_14001.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14002_ok : code_14002.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14003_ok : code_14003.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14004_ok : code_14004.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14005_ok : code_14005.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14006_ok : code_14006.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14007_ok : code_14007.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14008_ok : code_14008.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14009_ok : code_14009.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14010_ok : code_14010.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14011_ok : code_14011.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14012 : ExampleData 6 15 3 where
  ...
  targetZ := ![((1 : ℚ) / 5), ((1 : ℚ) / 5), ((-11 : ℚ) / 15), ((1 : ℚ) / 15), ((1 : ℚ) / 5), ((1 : ℚ) / 5)]
theorem code_14012_ok : code_14012.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14013 : ExampleData 6 15 3 where
  ...
  targetZ := ![((-1 : ℚ) / 5), ((1 : ℚ) / 5), ((1 : ℚ) / 5), ((1 : ℚ) / 15), ((11 : ℚ) / 15), ((1 : ℚ) / 5)]
theorem code_14013_ok : code_14013.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14014 : ExampleData 6 15 3 where
  ...
  targetZ := ![((1 : ℚ) / 5), ((-1 : ℚ) / 5), ((-1 : ℚ) / 5), ((-11 : ℚ) / 15), ((-1 : ℚ) / 15), ((-1 : ℚ) / 5)]
theorem code_14014_ok : code_14014.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14015_ok : code_14015.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14016 : ExampleData 6 15 3 where
  ...
  targetZ := ![((1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3)]
theorem code_14016_ok : code_14016.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14017_ok : code_14017.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14018_ok : code_14018.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14019_ok : code_14019.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14020 : ExampleData 6 15 3 where
  ...
  targetZ := ![((-1 : ℚ) / 5), ((-1 : ℚ) / 5), ((-11 : ℚ) / 15), ((-1 : ℚ) / 15), ((-1 : ℚ) / 5), ((1 : ℚ) / 5)]
theorem code_14020_ok : code_14020.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14021_ok : code_14021.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14022 : ExampleData 6 15 3 where
  ...
  targetZ := ![((1 : ℚ) / 5), ((1 : ℚ) / 5), ((1 : ℚ) / 15), ((-1 : ℚ) / 5), ((-1 : ℚ) / 5), ((-11 : ℚ) / 15)]
theorem code_14022_ok : code_14022.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14023_ok : code_14023.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14024_ok : code_14024.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14025_ok : code_14025.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14026 : ExampleData 6 15 3 where
  ...
  targetZ := ![((-1 : ℚ) / 15), ((-1 : ℚ) / 5), ((-1 : ℚ) / 5), ((11 : ℚ) / 15), ((1 : ℚ) / 5), ((1 : ℚ) / 5)]
theorem code_14026_ok : code_14026.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14027 : ExampleData 6 15 3 where
  ...
  targetZ := ![((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3)]
theorem code_14027_ok : code_14027.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14028_ok : code_14028.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14029 : ExampleData 6 15 3 where
  ...
  targetZ := ![((1 : ℚ) / 5), ((1 : ℚ) / 5), ((1 : ℚ) / 15), ((-11 : ℚ) / 15), ((1 : ℚ) / 5), ((1 : ℚ) / 5)]
theorem code_14029_ok : code_14029.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14030 : ExampleData 6 15 3 where
  ...
  targetZ := ![((1 : ℚ) / 5), ((11 : ℚ) / 15), ((1 : ℚ) / 15), ((-1 : ℚ) / 5), ((1 : ℚ) / 5), ((1 : ℚ) / 5)]
theorem code_14030_ok : code_14030.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14031 : ExampleData 6 15 3 where
  ...
  targetZ := ![((-1 : ℚ) / 5), ((-1 : ℚ) / 15), ((-11 : ℚ) / 15), ((1 : ℚ) / 5), ((-1 : ℚ) / 5), ((-1 : ℚ) / 5)]
theorem code_14031_ok : code_14031.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14032_ok : code_14032.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14033 : ExampleData 6 15 3 where
  ...
  targetZ := ![((-11 : ℚ) / 15), ((1 : ℚ) / 15), ((1 : ℚ) / 5), ((1 : ℚ) / 5), ((-1 : ℚ) / 5), ((-1 : ℚ) / 5)]
theorem code_14033_ok : code_14033.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14034 : ExampleData 6 15 3 where
  ...
  targetZ := ![((1 : ℚ) / 5), ((-1 : ℚ) / 5), ((-1 : ℚ) / 15), ((-11 : ℚ) / 15), ((-1 : ℚ) / 5), ((-1 : ℚ) / 5)]
theorem code_14034_ok : code_14034.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14035_ok : code_14035.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14036_ok : code_14036.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14037_ok : code_14037.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14038_ok : code_14038.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14039 : ExampleData 6 16 3 where
  ...
  targetZ := ![(0 : ℚ), ((-1 : ℚ) / 2), ((1 : ℚ) / 4), ((1 : ℚ) / 4), ((-1 : ℚ) / 2), (0 : ℚ)]
theorem code_14039_ok : code_14039.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14040_ok : code_14040.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14041_ok : code_14041.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14042_ok : code_14042.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14043_ok : code_14043.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14044_ok : code_14044.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14045_ok : code_14045.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14046_ok : code_14046.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14047_ok : code_14047.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14048_ok : code_14048.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14049_ok : code_14049.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14050_ok : code_14050.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14051_ok : code_14051.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14052_ok : code_14052.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14053 : ExampleData 6 16 3 where
  ...
  targetZ := ![(0 : ℚ), (0 : ℚ), ((-1 : ℚ) / 2), ((-1 : ℚ) / 4), ((-1 : ℚ) / 4), ((-1 : ℚ) / 2)]
theorem code_14053_ok : code_14053.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14054_ok : code_14054.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14055_ok : code_14055.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14056 : ExampleData 6 16 3 where
  ...
  targetZ := ![((-1 : ℚ) / 2), (0 : ℚ), ((-1 : ℚ) / 4), ((-1 : ℚ) / 4), (0 : ℚ), ((-1 : ℚ) / 2)]
theorem code_14056_ok : code_14056.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14057 : ExampleData 6 18 3 where
  ...
  targetZ := ![((-1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((-1 : ℚ) / 3)]
theorem code_14057_ok : code_14057.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14058 : ExampleData 6 18 3 where
  ...
  targetZ := ![((-1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3)]
theorem code_14058_ok : code_14058.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14059 : ExampleData 6 18 3 where
  ...
  targetZ := ![((1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3)]
theorem code_14059_ok : code_14059.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14060 : ExampleData 6 18 3 where
  ...
  targetZ := ![((1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3)]
theorem code_14060_ok : code_14060.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14061 : ExampleData 6 18 3 where
  ...
  targetZ := ![((1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3)]
theorem code_14061_ok : code_14061.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14062 : ExampleData 6 18 3 where
  ...
  targetZ := ![((1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3)]
theorem code_14062_ok : code_14062.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14063 : ExampleData 6 18 3 where
  ...
  targetZ := ![((1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3)]
theorem code_14063_ok : code_14063.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14064 : ExampleData 6 18 3 where
  ...
  targetZ := ![((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3)]
theorem code_14064_ok : code_14064.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14065 : ExampleData 6 18 3 where
  ...
  targetZ := ![((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3)]
theorem code_14065_ok : code_14065.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14066 : ExampleData 6 18 3 where
  ...
  targetZ := ![((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3)]
theorem code_14066_ok : code_14066.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14067 : ExampleData 6 18 3 where
  ...
  targetZ := ![((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3)]
theorem code_14067_ok : code_14067.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14068 : ExampleData 6 18 3 where
  ...
  targetZ := ![((-1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3)]
theorem code_14068_ok : code_14068.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14069 : ExampleData 6 18 3 where
  ...
  targetZ := ![((-1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3)]
theorem code_14069_ok : code_14069.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14070 : ExampleData 6 18 3 where
  ...
  targetZ := ![((1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3)]
theorem code_14070_ok : code_14070.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14071 : ExampleData 6 18 3 where
  ...
  targetZ := ![((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3)]
theorem code_14071_ok : code_14071.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14072 : ExampleData 6 18 3 where
  ...
  targetZ := ![((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3)]
theorem code_14072_ok : code_14072.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14073 : ExampleData 6 18 3 where
  ...
  targetZ := ![((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3)]
theorem code_14073_ok : code_14073.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14074 : ExampleData 6 18 3 where
  ...
  targetZ := ![((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3)]
theorem code_14074_ok : code_14074.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14075 : ExampleData 6 18 3 where
  ...
  targetZ := ![((1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((-1 : ℚ) / 3)]
theorem code_14075_ok : code_14075.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14076 : ExampleData 6 18 3 where
  ...
  targetZ := ![((1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((-1 : ℚ) / 3)]
theorem code_14076_ok : code_14076.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14077 : ExampleData 6 8 4 where
  ...
  targetZ := ![(0 : ℚ), (0 : ℚ), (0 : ℚ), (0 : ℚ), (0 : ℚ), (0 : ℚ)]
theorem code_14077_ok : code_14077.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14078 : ExampleData 6 8 4 where
  ...
  targetZ := ![(0 : ℚ), (0 : ℚ), (0 : ℚ), (0 : ℚ), (0 : ℚ), (0 : ℚ)]
theorem code_14078_ok : code_14078.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14079 : ExampleData 6 12 4 where
  ...
  targetZ := ![(0 : ℚ), (0 : ℚ), (0 : ℚ), (0 : ℚ), (0 : ℚ), (0 : ℚ)]
theorem code_14079_ok : code_14079.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14080 : ExampleData 6 12 4 where
  ...
  targetZ := ![((-1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((-1 : ℚ) / 3)]
theorem code_14080_ok : code_14080.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14081 : ExampleData 6 12 4 where
  ...
  targetZ := ![(0 : ℚ), (0 : ℚ), (0 : ℚ), (0 : ℚ), (0 : ℚ), (0 : ℚ)]
theorem code_14081_ok : code_14081.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14082 : ExampleData 6 12 4 where
  ...
  targetZ := ![((-1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3)]
theorem code_14082_ok : code_14082.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14083_ok : code_14083.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14084 : ExampleData 6 12 4 where
  ...
  targetZ := ![((1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3)]
theorem code_14084_ok : code_14084.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14085 : ExampleData 6 12 4 where
  ...
  targetZ := ![(0 : ℚ), (0 : ℚ), ((1 : ℚ) / 3), (0 : ℚ), (0 : ℚ), ((1 : ℚ) / 3)]
theorem code_14085_ok : code_14085.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14086 : ExampleData 6 12 4 where
  ...
  targetZ := ![((1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3)]
theorem code_14086_ok : code_14086.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14087 : ExampleData 6 12 4 where
  ...
  targetZ := ![((-1 : ℚ) / 3), ((-1 : ℚ) / 3), ((-1 : ℚ) / 3), ((-1 : ℚ) / 3), ((-1 : ℚ) / 3), ((-1 : ℚ) / 3)]
theorem code_14087_ok : code_14087.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14088 : ExampleData 6 12 4 where
  ...
  targetZ := ![((1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3)]
theorem code_14088_ok : code_14088.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14089 : ExampleData 6 12 4 where
  ...
  targetZ := ![(0 : ℚ), (0 : ℚ), (0 : ℚ), (0 : ℚ), (0 : ℚ), (0 : ℚ)]
theorem code_14089_ok : code_14089.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14090_ok : code_14090.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14091 : ExampleData 6 12 4 where
  ...
  targetZ := ![((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((-1 : ℚ) / 3)]
theorem code_14091_ok : code_14091.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14092 : ExampleData 6 12 4 where
  ...
  targetZ := ![((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3)]
theorem code_14092_ok : code_14092.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14093 : ExampleData 6 12 4 where
  ...
  targetZ := ![((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3)]
theorem code_14093_ok : code_14093.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14094 : ExampleData 6 12 4 where
  ...
  targetZ := ![((1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3)]
theorem code_14094_ok : code_14094.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14095_ok : code_14095.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14096 : ExampleData 6 12 4 where
  ...
  targetZ := ![((1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3)]
theorem code_14096_ok : code_14096.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14097 : ExampleData 6 12 4 where
  ...
  targetZ := ![((1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3)]
theorem code_14097_ok : code_14097.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14098 : ExampleData 6 12 4 where
  ...
  targetZ := ![(0 : ℚ), (0 : ℚ), (0 : ℚ), (0 : ℚ), (0 : ℚ), (0 : ℚ)]
theorem code_14098_ok : code_14098.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14099 : ExampleData 6 12 4 where
  ...
  targetZ := ![((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3)]
theorem code_14099_ok : code_14099.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14100_ok : code_14100.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
theorem code_14101_ok : code_14101.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14102 : ExampleData 6 18 4 where
  ...
  targetZ := ![((-1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3)]
theorem code_14102_ok : code_14102.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14103 : ExampleData 6 18 4 where
  ...
  targetZ := ![((1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3)]
theorem code_14103_ok : code_14103.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14104 : ExampleData 6 18 4 where
  ...
  targetZ := ![((1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3)]
theorem code_14104_ok : code_14104.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14105 : ExampleData 6 18 4 where
  ...
  targetZ := ![((1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3)]
theorem code_14105_ok : code_14105.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14106 : ExampleData 6 18 4 where
  ...
  targetZ := ![((-1 : ℚ) / 3), ((-1 : ℚ) / 3), ((-1 : ℚ) / 3), ((-1 : ℚ) / 3), ((-1 : ℚ) / 3), ((-1 : ℚ) / 3)]
theorem code_14106_ok : code_14106.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14107 : ExampleData 6 18 4 where
  ...
  targetZ := ![((1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3)]
theorem code_14107_ok : code_14107.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14108 : ExampleData 6 18 4 where
  ...
  targetZ := ![((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3)]
theorem code_14108_ok : code_14108.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14109 : ExampleData 6 18 4 where
  ...
  targetZ := ![((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3)]
theorem code_14109_ok : code_14109.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14110 : ExampleData 6 18 4 where
  ...
  targetZ := ![((-1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3)]
theorem code_14110_ok : code_14110.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14111 : ExampleData 6 18 4 where
  ...
  targetZ := ![((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((-1 : ℚ) / 3)]
theorem code_14111_ok : code_14111.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14112 : ExampleData 6 18 4 where
  ...
  targetZ := ![((-1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3)]
theorem code_14112_ok : code_14112.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14113 : ExampleData 6 18 4 where
  ...
  targetZ := ![((1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3)]
theorem code_14113_ok : code_14113.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14114 : ExampleData 6 18 4 where
  ...
  targetZ := ![((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3)]
theorem code_14114_ok : code_14114.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
...
def code_14115 : ExampleData 6 18 4 where
  ...
  targetZ := ![((1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((1 : ℚ) / 3), ((-1 : ℚ) / 3), ((-1 : ℚ) / 3)]
theorem code_14115_ok : code_14115.OK := by
  refine ⟨?_, ?_, ?_, ?_⟩
  · decide          -- support membership (kernel)
  · decide          -- residue-shift screen (kernel)
  · native_decide   -- normalization
