...
% =====================================================================
\begin{frame}{8 Verified BD16 $((7,2,3))$ Codes in Lean}
...
Remaining: 3 vectors need $\sqrt{5}/\sqrt{10}$ field extension; 2 proven impossible.
12 vectors total $\Rightarrow$ 10 feasible, 6 verified in Lean (8 distinct codes).
}
\end{frame}
...
$(1,1,2,2,2,3,4)$ & 16 & 83  & phase-only $+$ families & \textcolor{Teal}{analytical \checkmark} \\
\rowcolor{Amber!10}
$(1,1,2,2,3,3,3)$ & 16 & 85  & continuous, needs $\sqrt{10}$  & \textcolor{Amber}{pending} \\
\rowcolor{Amber!10}
$(1,1,1,2,3,3,4)$ & 16 & 85  & isolated, needs $\sqrt{10}$    & \textcolor{Amber}{pending} \\
\rowcolor{Amber!10}
$(1,1,1,2,2,3,5)$ & 14 & 99  & isolated, needs $\sqrt{5}$     & \textcolor{Amber}{pending} \\
\rowcolor{Coral!8}
...
10 feasible, 6 in Lean; 3 pending need $\QQ(\sqrt{2},\sqrt{3},\sqrt{5},i)$.}
\end{frame}
